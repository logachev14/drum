...
namespace callback
{
    ...
    public:
        ...
        //нехорошо плодить делегатов просто так, надо делать это клоном
        DelegateLambda & operator=( const DelegateLambda & that ) = delete;
        ...
        bool operator==( DelegateLambda * that )
        {
            return false;
        }
    ...
    public:
        ...
        Callback & bind( TObject && object )
        {
            m_delegate = new( m_place ) DelegateLambda<TObject, TOutput, TInput ...>( (TObject &&) object );
