...
//#define UMBA_ASSERT( statement )      { if(!(statement)) {std::cout << "Assert failed in:" << __FILE__ << "at line" << __LINE__;} }
...
*/
    ...
    #define UMBA_STATIC_ASSERT(x)  static_assert(x, "static assertion error")

    #define UMBA_STATIC_ASSERT_MSG( cond, msg ) static_assert( cond, #msg )
