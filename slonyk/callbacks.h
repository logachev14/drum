/***************************************************************************************************
 ...
 Этот файл взят из статьи, но модифицирован. Изменения чисто косметичиские
...
#ifndef UNIVERSAL_CALLBACK_HPP
#define UNIVERSAL_CALLBACK_HPP
...
#define CALLBACK_BIND( ... ) UNIVERSAL_CALLBACK_GET_BIND_MACRO( __VA_ARGS__, CALLBACK_BIND_MEMBER, CALLBACK_BIND_FREE ) (__VA_ARGS__)

// это макрос для биндинга метода
#define CALLBACK_BIND_MEMBER( object, member) ( callback::GetCallbackFactory( &member ).Bind< &member >( &object ) )

// это макрос для биндинга свободной функции
#define CALLBACK_BIND_FREE( function )  ( callback::GetCallbackFactory( &function ).Bind< &function >() )
